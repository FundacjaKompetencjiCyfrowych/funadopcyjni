	...
	"inline-flex items-center justify-center rounded-[32px] text-center font-nunito font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2",
	{
		variants: {
			variant: {
				...
				light:
					"bg-white text-text-dark border border-text-dark hover:bg-gray-light focus:ring-text-dark text-base py-[10px] px-4",
				carousel:
					"bg-primary text-black hover:bg-primary-hover focus:ring-primary text-base font-medium py-3 px-6 rounded-full",
			},
		},
		defaultVariants: {
			variant: "default",
